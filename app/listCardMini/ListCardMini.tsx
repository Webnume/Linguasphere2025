        ...
        (categorie) =>
          categorie.image && (
            <Link href={categorie.linkHref} key={categorie.name}>
              <article className="group sm:flex sm:flex-col border border-gray-700 sm:max-w-[280px] p-4 h-full hover:border-orange hover:border-1 hover:scale-105 transition ease-in-out">
                <Image
                ...
                />
                <h2 className="uppercase font-semibold text-gray-700 group-hover:text-orange">
                  {categorie.name ===

...
export const metadata: Metadata = {
  title: "Dépannage informatique Lattes - Réparation ordinateur",
  description:
    "Dépannage informatique Lattes. Réparation ordinateur Lattes. Assistance informatique à domicile et maintenance par des réparateurs PC",
};

export default function Home() {
  return (
    <>
      <Banner title={"Dépannage informatique Lattes"} />
      <section className="flex flex-col w-full max-w-[1440px] p-4">
        <h2 className="flex items-center text-xl sm:text-2xl text-center w-full p-4 lg:p-8">
          ...
          assistance informatique pour Lattes.
        </h2>
        <Avantages />
